...
#else
extern void __list_add(struct list_head *newentry,
			      struct list_head *prev,
			      struct list_head *next);
#endif
...
static inline void hlist_move_list(struct hlist_head *old,
				   struct hlist_head *newentry)
{
	newentry->first = old->first;
	if (newentry->first)
		newentry->first->pprev = &newentry->first;
	old->first = NULL;
}
